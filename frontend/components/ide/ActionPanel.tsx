...
export function ActionPanel({
  ...
  return (
    <div className="w-72 border-l border-zinc-800 bg-zinc-900/30 flex flex-col shrink-0 overflow-y-auto">
      ...
      <div className="p-4 space-y-5">
        ...
        <div className="space-y-3">
          ...
          <button
            ...
            title={isSandboxConnected ? "Sync local files to sandbox" : "Start sandbox to sync"}
          >
            <div className="flex items-center gap-2">
              <Zap className={cn("w-4 h-4", isSandboxConnected && "fill-purple-400")} />
                    ...
                    deployerStatus === "SUCCESS" ? "Deployed ✓" :
                      !hasCompiledWasm ? "Compile First" :
                        !isWalletConnected ? "Connect Wallet" :
                          `Deploy to ${network === "mainnet" ? "Mainnet" : "Testnet"}`}
                </div>
              ...
              <div className="space-y-3 pt-3 border-t border-zinc-800/50">
                ...
                <div className="p-3 rounded-md bg-zinc-900/80 border border-zinc-800 space-y-3">
                  <div>
                    ...
                    <div className="flex items-center gap-2 mt-1">
                      <code className="text-xs font-mono text-purple-400/90 truncate flex-1">
                        {latestContractId.slice(0, 12)}...
                        {latestContractId.slice(-8)}
                      </code>
                      <button
                      ...
                      >
                        <Copy
                          className={cn(
                            "w-3.5 h-3.5",
                            copied ? "text-green-400" : "text-zinc-500",
                          )}
                        />
                      </button>
                    </div>
                  ...
                  <button
                    onClick={() =>
                      window.open(
                        `https://stellar.expert/explorer/testnet/contract/${latestContractId}`,
                        "_blank",
                      )
                    }
              ...
              {!isSandboxConnected ? (
                <div className="p-3 rounded-md bg-zinc-900/50 border border-zinc-800/80 flex flex-col gap-2">
                  ...
                  <p className="text-xs text-zinc-500">
                    Start the sandbox to generate TypeScript bindings for your
                    contracts.
                  </p>
                </div>
                ...
                <div className="p-3 rounded-md bg-zinc-900/50 border border-zinc-800/80 flex flex-col gap-2">
                  ...
                  <p className="text-xs text-zinc-500">
                    Deploy a contract in Contract Mode first to generate
                    bindings.
                  </p>
                </div>
              ) : (
                <div className="space-y-2">
                  ...
                  <select
                    ...
                    defaultValue={
                      latestContractId || deployedContracts[0]?.address
                    }
                  >
                    {latestContractId && (
      ...
      <GitHubAuthDialog
        open={showGitHubAuthDialog}
        onOpenChange={setShowGitHubAuthDialog}
      />
      <GitHubRepoDialog
        open={showGitHubRepoDialog}
        onOpenChange={setShowGitHubRepoDialog}
      />
    </div>
  );
}
