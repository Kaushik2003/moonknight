        ...
        <div className="flex-1 bg-zinc-900 flex flex-col">
          ...
          sandboxStatus !== "preview_starting" ? (
            ...
            <div className="flex-1 relative flex flex-col">
              ...
              <div className="h-10 bg-zinc-900 border-b border-zinc-800 flex items-center gap-2 px-3 shrink-0 z-10">
                {/* Status dot */}
                ...
                {/* URL bar */}
                <div className="flex-1 flex items-center bg-zinc-800/60 border border-zinc-700/50 rounded-md px-3 h-6 min-w-0">
              ...
              <div className="text-zinc-600 flex flex-col items-center gap-4">
                ...
                {!onSpawnSandbox && (
                  <div className="mt-4 px-4 py-2 rounded-lg bg-zinc-800/50 border border-zinc-700/50 text-xs text-zinc-500">
                    Click the <span className="text-purple-400">Code</span>{" "}
